...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#08080E] border-r border-border flex flex-col justify-between h-screen sticky top-0 shrink-0 select-none">
                    ...
                    return (
                      <li key={item.id} className="relative">
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold tracking-wide transition-colors group relative ${
      ...
      <div className="p-4 border-t border-border bg-[#07070C]">
        <div className="bg-[#0B0B12]/50 border border-border rounded-xl p-3.5 space-y-2.5">
