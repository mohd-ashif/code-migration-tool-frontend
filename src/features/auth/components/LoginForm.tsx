  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-gradient-to-r from-[#7C6CFF] to-[#6351FF] hover:opacity-95 disabled:opacity-50 text-white font-semibold text-sm rounded-2xl py-4 shadow-lg shadow-[#7C6CFF]/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer"
      >
        {loading ? (
          <>
